    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-5">
        <div className="space-y-5">
          <div className="h-10 w-40 bg-gray-200 dark:bg-white/10 rounded animate-pulse" />
          <div className="h-[500px] rounded-2xl bg-gray-200 dark:bg-white/10 animate-pulse" />
        </div>
      </div>
    </div>
  )

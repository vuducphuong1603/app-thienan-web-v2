    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-5">
        <div className="space-y-5">
          <div className="h-10 w-60 bg-gray-200 dark:bg-white/10 rounded animate-pulse" />
          <div className="grid grid-cols-2 gap-4">
            {[1, 2].map((i) => (
              <div key={i} className="h-[400px] rounded-2xl bg-gray-200 dark:bg-white/10 animate-pulse" />
            ))}
          </div>
        </div>
      </div>
